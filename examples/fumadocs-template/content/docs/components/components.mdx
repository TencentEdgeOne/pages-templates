...
<CardGroup>
  ...
  <Card title="Deploying" href="/docs/deployment/deploying">
...
- [Deploy](/docs/deployment/deploying) your documentation to production
- Review [Configuration](/docs/getting-started/configuration) options
