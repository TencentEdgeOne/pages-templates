...
## Forms
  ...
  * [Form2Channel](https://form2channel.com) - Send form submissions to Google Sheets, Email, Email, Slack or Webhooks. Unlimited and free. Features include multiple recipients, custom thank-you pages, file uploads, and more.
  ...
  * [smartforms.dev](https://smartforms.dev/) - Powerful and easy form backend for your website, forever free plan allows 50 submissions per month, 250MB file storage, Zapier integration, CSV/JSON export, custom redirect, custom response page, Slack bot, single email notifications.
...
## Analytics, Events and Statistics
  ...
  * [LogSpot](https://logspot.io) - Full unified web and product analytics platform, including embeddable analytics widgets and automated robots (slack and webhooks). Free plan includes 10,000 events per month.
...
## Miscellaneous
  ...
  * [Form2Channel](https://form2channel.com) — Place a static html form on your website and receive submissions directly to Google Sheets, Email, Slack, or HTTP. No coding is necessary.
  ...
  * [newreleases.io](https://newreleases.io/) - Receive notifications on email, Slack, Discord, and custom webhooks for new releases from GitHub, GitLab, Bitbucket, Python PyPI, Java Maven, Node.js NPM, Node.js Yarn, Ruby Gems, PHP Packagist, .NET NuGet, Rust Cargo and Docker Hub.
