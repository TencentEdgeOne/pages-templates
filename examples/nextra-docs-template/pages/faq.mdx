...
- [GitHub Issues](https://github.com/shuding/nextra/issues)
- [Discord Community](https://discord.gg/nextra)
- [Stack Overflow](https://stackoverflow.com/questions/tagged/nextra) 